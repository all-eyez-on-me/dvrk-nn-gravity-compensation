classdef controller < handle
    ...
    methods(Access = public)
        ...
        function obj = controller(mtm_arm,...
            ...
            obj.dynamic_params_vec = dynamic_params_vec;
...
%                 msg.Effort(5) = 0.05;
        ...
        function Torques = base_controller(obj, q, q_dot)
            vel = q_dot;
            if nargin(@analytical_regressor_pos_mat) == 6
                Torques_pos = analytical_regressor_pos_mat(obj.g, q(2),q(3),q(4),q(5),q(6))*obj.dynamic_params_vec;
                Torques_neg = analytical_regressor_neg_mat(obj.g, q(2),q(3),q(4),q(5),q(6))*obj.dynamic_params_vec;

            else
                Torques_pos = analytical_regressor_pos_mat(obj.g, q(1),q(2),q(3),q(4),q(5),q(6))*obj.dynamic_params_vec;
                Torques_neg = analytical_regressor_neg_mat(obj.g, q(1),q(2),q(3),q(4),q(5),q(6))*obj.dynamic_params_vec;
            end
            Torques = zeros(7,1);
            for i =1:6
