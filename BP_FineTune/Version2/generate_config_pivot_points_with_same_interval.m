function [config_mat, mistakes_count] = generate_config_pivot_points_with_same_interval(joint_pivot_num)
    % joint limits
    ...
    joint_pivot_num_list = [1,1,1,1,1,1]*joint_pivot_num;
    pivot_mat = [];
...
function config_mat = joint_all_combs(pivot_mat, joint3_coup_pivot_mat)
    ...
    config_mat = zeros(6, joint_pivot_num^6);
    count = 0;
